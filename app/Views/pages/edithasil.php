        ...
        <div class="p-5">
            ...
            <form class=" user" action="<?= base_url(); ?>/hasil/update/<?= $data['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-user <?= ($validation->hasError('namapasien')) ? 'is-invalid' : ''; ?>" id="namapasien" name="namapasien" value="<?= (old('namapasien')) ? old('namapasien') : $data['namapasien'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-user <?= ($validation->hasError('nomorlab')) ? 'is-invalid' : ''; ?>" id="nomorlab" name="nomorlab" value="<?= (old('nomorlab')) ? old('nomorlab') : $data['nomorlab'] ?>">
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <label for="filehasil" class="custom-file-label"><?= $data['namafile']; ?></label>
                        <div class="invalid-feedback">
